  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-20">
          {filteredProducts.map((product, index) => (
            <Link key={product.id} href={`/products/${product.id}`}>
              <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer border-border hover:border-primary/20 hover:-translate-y-1">
                <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-card-foreground mb-2 text-balance group-hover:text-primary transition-colors line-clamp-2">
                      {product.name}
                    </h3>
      ...
      <Link href="/products/add">
        <Button
          size="lg"
          className="fixed bottom-6 right-6 rounded-full w-14 h-14 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-40"
